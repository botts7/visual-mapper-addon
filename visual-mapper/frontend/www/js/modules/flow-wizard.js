...
import FlowRecorder from './flow-recorder.js?v=0.2.47';
import FlowCanvasRenderer from './flow-canvas-renderer.js?v=0.2.47';
import FlowInteractions from './flow-interactions.js?v=0.2.47';
import FlowStepManager from './flow-step-manager.js?v=0.2.47';
import LiveStream from './live-stream.js?v=0.2.47';
import ElementTree from './element-tree.js?v=0.2.47';
import APIClient from './api-client.js?v=0.2.47';
import SensorCreator from './sensor-creator.js?v=0.2.47';

// Step modules
import * as Step1 from './flow-wizard-step1.js?v=0.2.47';
import * as Step2 from './flow-wizard-step2.js?v=0.2.47';
import * as Step3 from './flow-wizard-step3.js?v=0.2.47';
import * as Step4 from './flow-wizard-step4.js?v=0.2.47';
import * as Step5 from './flow-wizard-step5.js?v=0.2.47';

// Dialog module
import * as Dialogs from './flow-wizard-dialogs.js?v=0.2.47';

// Element actions module
import * as ElementActions from './flow-wizard-element-actions.js?v=0.2.47';
...
class FlowWizard {
    ...
    async openInEditMode(actionDef, deviceId) {
        ...
        const FlowRecorder = (await import('./flow-recorder.js?v=0.2.47')).default;
