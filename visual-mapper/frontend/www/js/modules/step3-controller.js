...
import * as StreamManager from './stream-manager.js?v=0.2.35';
import * as CanvasOverlayRenderer from './canvas-overlay-renderer.js?v=0.2.35';
import * as GestureHandler from './gesture-handler.js?v=0.2.35';
