...
import * as StreamManager from './stream-manager.js?v=0.4.0-beta.3.9';
import * as CanvasOverlayRenderer from './canvas-overlay-renderer.js?v=0.4.0-beta.3.9';
import * as GestureHandler from './gesture-handler.js?v=0.4.0-beta.3.9';
