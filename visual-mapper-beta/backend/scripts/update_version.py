...
def update_readme_files(new_version: str):
    ...
    readme_files = [Path("README.md"), Path("www/branding/README.md")]
...
def main():
    ...
    parser.add_argument(
        "version", help="New version number (e.g., 0.0.5, 0.1.0, 1.0.0)"
    )
    parser.add_argument(
        "--build-date", help="Build date (YYYY-MM-DD). Defaults to today.", default=None
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
